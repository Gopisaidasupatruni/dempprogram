...
/* FUNCTION PROTOTYPES */
void readPerson(SP*, char*);
void calculate(SP*,SD);
/*MAIN PROGRAM */
/*main: determines which person is oldest and person with longest name */
int main(int argc, char* argv[]) {
	/* If command line arguments are not equal to five */
    if (argc != 5) {
	    printf("Usage ./exe filename day month year \n");
        return 1;
    }
       SD current_date;
 ...
 * modified:19/9/2024
*/
void readPerson(SP *p, char *filename) {
